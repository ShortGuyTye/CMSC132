...
public class Video implements Comparable<Video> {
	...
	public Video(String title, String url, int durationInMinutes, Genre videoGenre) {
		if (title == null || url == null || videoGenre == null || title.isBlank() || url.isBlank()
				|| durationInMinutes <= 0) {
	...
	public Video(Video video) {
		...
		comments = new ArrayList<>(video.comments);
	}
	...
	public ArrayList<String> getComments() {
		ArrayList<String> temp = new ArrayList<String>(this.comments);
		return temp;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Video) {
			if (this.title.equals(((Video) obj).getTitle())) {
				return true;
			}
		}
		return false;
